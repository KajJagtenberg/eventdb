...
var file_proto_transport_proto_rawDesc = []byte{
	...
	0x32, 0xb0, 0x03, 0x0a, 0x11, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53,
	...
	0x0a, 0x12, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x73, 0x74, 0x69,
	0x6d, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74,
...
var file_proto_transport_proto_depIdxs = []int32{
	...
	6, // 7: transport.EventStoreService.EventCountEstimate:input_type -> transport.EventCountRequest
	0, // 8: transport.EventStoreService.Add:output_type -> transport.EventResponse
	0, // 9: transport.EventStoreService.Get:output_type -> transport.EventResponse
	0, // 10: transport.EventStoreService.GetAll:output_type -> transport.EventResponse
	5, // 11: transport.EventStoreService.Checksum:output_type -> transport.ChecksumResponse
	7, // 12: transport.EventStoreService.EventCount:output_type -> transport.EventCountResponse
	7, // 13: transport.EventStoreService.EventCountEstimate:output_type -> transport.EventCountResponse
