...
var file_proto_transport_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x41, 0x74, 0x32, 0xff, 0x03, 0x0a, 0x11, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x74,
...
var file_proto_transport_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_proto_transport_proto_goTypes = []interface{}{
	...
	(*EventResponse_Event)(nil),       // 10: transport.EventResponse.Event
	(*AddRequest_EventData)(nil),      // 11: transport.AddRequest.EventData
	(*ListStreamsReponse_Stream)(nil), // 12: transport.ListStreamsReponse.Stream
}
var file_proto_transport_proto_depIdxs = []int32{
	10, // 0: transport.EventResponse.events:type_name -> transport.EventResponse.Event
	11, // 1: transport.AddRequest.events:type_name -> transport.AddRequest.EventData
	12, // 2: transport.ListStreamsReponse.streams:type_name -> transport.ListStreamsReponse.Stream
	...
	0,  // 10: transport.EventStoreService.Add:output_type -> transport.EventResponse
	0,  // 11: transport.EventStoreService.Get:output_type -> transport.EventResponse
	0,  // 12: transport.EventStoreService.GetAll:output_type -> transport.EventResponse
	5,  // 13: transport.EventStoreService.Checksum:output_type -> transport.ChecksumResponse
	7,  // 14: transport.EventStoreService.EventCount:output_type -> transport.EventCountResponse
	7,  // 15: transport.EventStoreService.EventCountEstimate:output_type -> transport.EventCountResponse
	9,  // 16: transport.EventStoreService.ListStreams:output_type -> transport.ListStreamsReponse
