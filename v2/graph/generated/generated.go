...
func (ec *executionContext) field_Query_streams_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNStreamsInput2githubᚗcomᚋkajjagtenbergᚋeventflowdbᚋgraphᚋmodelᚐStreamsInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNStreamsInput2githubᚗcomᚋkajjagtenbergᚋeventflowdbᚋgraphᚋmodelᚐStreamsInput(ctx context.Context, v interface{}) (model.StreamsInput, error) {
